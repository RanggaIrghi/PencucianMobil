...
<div class="flex h-screen w-full font-poppins overflow-hidden bg-[#F9FAFB]">
    ...
    <div class="w-full lg:w-7/12 flex flex-col h-full relative">
        ...
        <div class="flex-1 flex flex-col px-8 lg:px-16 pt-4 pb-8">
            ...
            <div class="mt-8">
                <a href="{{ url('/') }}"
                    class="inline-block bg-[#6EE7B7] hover:bg-[#4ADE80] text-teal-900 font-medium px-10 py-3 rounded-full shadow-md transition transform hover:-translate-y-1 text-center">
                    Kembali
                </a>
            </div>
