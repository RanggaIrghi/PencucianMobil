...
<div class="flex min-h-screen bg-[#F9FAFB] font-poppins">
    ...
    <div class="flex-1 lg:ml-64 p-8">
        ...
        <div class="flex flex-wrap items-center gap-4 mb-6">
            ...
            <button class="flex items-center gap-2 bg-white px-4 py-3 rounded-xl shadow-sm border border-gray-100 text-sm font-medium text-[#4ADE80] hover:bg-green-50">
                ...
                <thead class="bg-white border-b border-gray-100">
                    <tr>
                        ...
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">Invoice ID <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">Date <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">Customer <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">No polisi <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">Total <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                        <th class="p-6 text-xs font-bold text-gray-800 uppercase tracking-wider">
                            <div class="flex items-center gap-1 cursor-pointer">Status <svg class="w-3 h-3 text-gray-400" fill="currentColor" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div>
                        </th>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-6">
                            <div class="flex items-center gap-4">
                                <div class="w-8 h-8 rounded-lg bg-[#4ADE80] flex items-center justify-center text-white shrink-0">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg>
                                </div>
                                <span class="text-sm font-medium text-gray-900">#000000001</span>
                            </div>
                        </td>
                        <td class="p-6 text-sm text-gray-600">02/12/2025 06:24</td>
                        <td class="p-6 text-sm font-medium text-gray-900">Rangga</td>
                        <td class="p-6 text-sm text-gray-600">D 1234 VN</td>
                        <td class="p-6 text-sm font-medium text-gray-900">Rp 10.000.00</td>
                        <td class="p-6">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-green-50 text-[#4ADE80] uppercase tracking-wide">
                                Washing
                            </span>
                        </td>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="p-6">
                            <div class="flex items-center gap-4">
                                ...
                                <span class="text-sm font-medium text-gray-900">#000000002</span>
                            </div>
                        </td>
                        <td class="p-6 text-sm text-gray-600">02/12/2025 06:24</td>
                        <td class="p-6 text-sm font-medium text-gray-900">Heldi</td>
                        <td class="p-6 text-sm text-gray-600">D 1234 VN</td>
                        <td class="p-6 text-sm font-medium text-gray-900">Rp 10.000.00</td>
                        <td class="p-6">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-red-50 text-red-500 uppercase tracking-wide">
                                Queue
                            </span>
                        </td>
                        <td class="p-6 text-right">
